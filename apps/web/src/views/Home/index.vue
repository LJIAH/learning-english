<template>
  <div class="max-w-300 w-full mx-auto mt-10 pb-30 px-6">
    ...
    <div class="rounded-[20px] p-10 text-center">
      <div ref="textWhy" class="text-2xl font-bold text-gray-800">
        为什么选择我们?
      </div>
      <div ref="textWhyContent" class="text-1xl font-bold text-gray-600 mt-4">
    ...
    <div class="relative text-center py-8 mb-6">
      ...
      <div class="relative z-10">
        <span
          ref="textCore"
          class="inline-block px-4 py-1.5 bg-indigo-100 text-indigo-600 text-sm font-medium rounded-full mb-4"
          >✨ 核心优势</span
        >
        <div
          ref="coreTitle"
          class="text-3xl font-bold bg-linear-to-r from-gray-800 via-indigo-700 to-indigo-500 bg-clip-text text-transparent"
        >
          重新定义英语学习方式
        </div>
        <div
          ref="coreContent"
          class="text-base text-gray-500 mt-4 mx-auto leading-relaxed"
        >
          融合前沿 AI
    ...
    >
      <div
        ...
        :key="item.title"
        data-card
        class="group relative overflow-hidden rounded-3xl p-8 cursor-pointer transition-all duration-500 hover:-translate-y-2 bg-white border border-gray-200 hover:border-indigo-300 hover:shadow-xl hover:shadow-indigo-500/10"
      >
        <!-- 装饰性背景图案 -->
        <div
